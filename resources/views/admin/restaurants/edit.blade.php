...
<head>
    ...
    <title>Editar Restaurante{{ $restaurant ? ': ' . $restaurant->name : '' }}</title>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('admin.restaurants.index') }}" class="btn btn-sm btn-outline-secondary me-2">
            <i class="fas fa-arrow-left"></i> Cancelar
        </a>
        <button type="submit" form="editRestaurantForm" class="btn btn-sm btn-primary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-store text-primary"></i> Información del Restaurante
                </h5>
            </div>
            <div class="card-body">
    ...
    @method('PUT')
                    ...
                    <div class="mb-3">
                            <label for="name" class="form-label">
                                <i class="fas fa-store me-1 text-primary"></i> Nombre del Restaurante
                            </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label for="postal_code" class="form-label">
                                            <i class="fas fa-mail-bulk me-1 text-primary"></i> C.P.
                                        </label>
                        ...
                        <div class="col-md-6">
                            <h5 class="border-bottom pb-2 mb-3">
                                <i class="fas fa-user-tie me-1 text-primary"></i> Datos de Contacto
                            </h5>
